        ...
        <>
            ...
            <div className="relative w-full">
                ...
                <div className="relative w-full h-60 flex items-center justify-center">
                    <h1 className="text-[34px] font-bold text-[#2E3E65] text-center font-poppins">Product Thinking POV</h1>
                </div>
                <div 
...
export default ProductThinkingPOV;
